                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example2">
                            <thead>
                            <tr>
                                <th>{{trans('sections_trans.Num')}}</th>
                            ...
                            <tbody>
                                @foreach($services as $service)
                                    <tr>
                                        ...
                                        <td>{{$service->price}}</td>
                                        <td>
                                            <div style="left: 17px"class="dot-label bg-{{$service->status == 1 ? 'success':'danger'}} ml-1"></div>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"  data-toggle="modal" data-target="#edit{{$service->id}}" href="#"><i class="las la-pen"></i></a>
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"  data-toggle="modal" data-target="#delete{{$service->id}}"  href="#"><i class="las la-trash"></i></a>
                                        </td>
                                    </tr>        
