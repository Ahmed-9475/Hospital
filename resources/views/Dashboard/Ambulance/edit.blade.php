                    ...
                    <div class="row">
                        <div class="col-1 d-flex justify-content-end" >
                            <div class="form-check">
                                <input {{$ambulance->status == 1?'checked':''}} class="form-check-input" value="1" name='status' type="checkbox" id="flexSwitchCheckDefault">
                            </div>
                        </div>
                        <div  class="col-2">
                            <label class="form-check-label" for="flexSwitchCheckDefault">{{trans('insurance.activation_status')}}</label>
                        </div>
                    </div>
