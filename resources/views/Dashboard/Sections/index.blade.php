                                ...
                                <div class="card-body">
                                    <div class="">
                                        <table class="table text-md-nowrap" id="example2">
                                            <thead>
                                            <tr>
                                                <th class="wd-15p border-bottom-0">{{trans('sections_trans.Num')}}</th>
                                                ...
                                                <th class="wd-20p border-bottom-0">{{trans('sections_trans.section_doctors')}}</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                            <a class="btn btn-primary" href="{{route('sections.show',$section->id)}}" role="button">{{trans('sections_trans.section_doctors')}}</a>
                                                    </td>
