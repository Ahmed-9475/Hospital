                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" value="{{$doctor->name}}" name="name" type="text" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" value="{{$doctor->price}}" name="price" type="number" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        ...
                                        @foreach($doctor->appointmentDoctors as $selectAppointment)
                                        <option value="{{$selectAppointment->id}} " selected >{{$selectAppointment->name}}</option>
                                        @endforeach
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input type="file" accept="image/*" value="{{'Asdas'}}" name="photo" onchange="loadFile(event)">
                                    @if($doctor->image)
                                    <img style="border-radius:50%" src="{{asset('Dashboard/img/doctors/'.$doctor->image->filename)}}" width="150px" height="150px" id="output"/>
                                    @else
                                    <img style="border-radius:50%" src="{{asset('Dashboard/img/doctor_default.jpg')}}" width="150px" height="150px" id="output"/>
                                    @endif
                                </div>
                            </div>
