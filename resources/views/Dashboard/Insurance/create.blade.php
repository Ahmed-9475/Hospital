                ...
                <form action="{{route('insurances.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="name"  value="{{ old('name') }}"  class="form-control @error('insurance_code') is-invalid @enderror">
                                @error('name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="number" name="discount_percentage" value="{{ old('discount_percentage') }}"  class="form-control @error('discount_percentage') is-invalid @enderror">
                        ...
                        <div class="col">
                            ...
                            <input type="number" name="Company_rate" value="{{ old('Company_rate') }}" class="form-control @error('Company_rate') is-invalid @enderror">
                                @error('Company_rate')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea rows="5" cols="10"  name="notes" class="form-control @error('notes') is-invalid @enderror">{{ old('notes') }}</textarea>
                                @error('notes')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
